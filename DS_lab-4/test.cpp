...
TEST(List, insertafter) {
    ...
    obj1.insertAfter(5, 3);
    EXPECT_EQ(4, obj1.getValues()[4]);
    obj1.print();
...
TEST(List, remove) {
    ...
    for (int i = 0; i < 4; i++)
    {
        EXPECT_EQ(j++, obj1.getValues()[i]);
        cout << obj1.getValues()[i] << endl;
    }
    obj1.print();
